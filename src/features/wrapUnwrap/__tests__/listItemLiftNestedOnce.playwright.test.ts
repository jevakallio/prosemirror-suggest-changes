...
test.describe("single nested list item lift | [ReplaceAroundStep, ReplaceAroundStep]", () => {
  ...
  test("should revert the lift of a nested list item by reverting a structure suggestion", async ({
    page,
  }) => {
