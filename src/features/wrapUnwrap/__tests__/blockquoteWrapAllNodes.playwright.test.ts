...
test.describe("wrap multiple nodes with a blockquote | [ReplaceAroundStep]", () => {
  ...
  test("should revert the wrap of multiple paragraphs in a blockquote by reverting a structure suggestion", async ({
    page,
  }) => {
